...
export const OpenRocketryInitiative = () => (
  <div>
    <Typography component="div" style={styles.paragraph}>
      ...
      <ul>
        <li>
          <strong>Smart launchpad</strong>
          {' '}
          &mdash; trigger launch over WiFi and measure motor thrust curves (
          <Link external href="https://github.com/openrocketryinitiative/launchpad" text="repo" />
          )
        </li>
        <li>
          <strong>Motors</strong>
          {' '}
          &mdash; optimize rocket motor thrust curves by adjusting fuel mixtures (
          <Link external href="https://github.com/openrocketryinitiative/motors" text="repo" />
          )
        </li>
        <li>
          <strong>Rocket flight computer</strong>
          {' '}
          &mdash; measure real-time rocket position and control chute deployment (
          <Link external href="https://github.com/openrocketryinitiative/carlson" text="repo" />
          )
        </li>
      </ul>
    </Typography>
    ...
    <Typography style={styles.paragraph}>
      ...
      communication with the rocket while in flight. The ORI team has successfully
      deployed Carlson in numerous launches and the collected orientation data
      permitted the development of a real-time apogee-detection algorithm.
    </Typography>
    ...
    <Typography style={styles.paragraph}>
      ...
      some Nichrome wire, igniting the rocket&apos;s blast-cap and ejecting the
      parachute. Here&apos;s a video of the
      {' '}
      <Link external href="https://www.instagram.com/p/Bb0dSJujduq/" text="parachute being ejected" />
      .
    </Typography>
    ...
    <Typography style={styles.paragraph}>
      ...
      {' '}
      <Link external href="https://docs.google.com/presentation/d/1OxAxDKqtxr4odVjT6q38U2s4oX1R2K-lVKEJCeqgmxo/edit?usp=sharing" text="Google Slides" />
      .
    </Typography>
    ...
    <Typography styles={styles.parachute}>
      ...
      {' '}
      <Link external href="https://www.instagram.com/openrocketryinitiative/" text="Instagram" />
      .
    </Typography>
...
export const Audiolux = props => (
  <div>
    ...
    <Typography style={styles.caption}>
      Side-view of the Audiolux case. Switches allow user to turn LED-strips on
      and off.
    </Typography>

    <Typography style={styles.paragraph}>
      The original Audiolux system was built as a project for an art class. For
      the upgraded version, I bought a faster microprocessor (Teensy) that
      could run a small real-time FFT onboard. This allows for visualization of
      the frequency spectrum of the incoming audio instead of just amplitude.
    </Typography>
    ...
    <Typography style={styles.paragraph}>
      ...
      FFT output logarithmically into 16 bins and assigns each a color based on
      its number. The result is a hypnotizing audio-synchronized lightshow.
    </Typography>

    <Typography style={styles.paragraph}>
      Two longer strips act as &ldquo;bass visualizers&rdquo;: a pulse of light shoots down
      them whenever the lowest FFT bin passes a certain predefined threshold.
    </Typography>

    <Typography style={styles.paragraph}>
      More pictures can be found
      {' '}
      <Link external text="here" href="https://drive.google.com/drive/u/0/folders/0B0o_ibOPs__CRDcxNHRzSUI5RW8" />
      .
    </Typography>
